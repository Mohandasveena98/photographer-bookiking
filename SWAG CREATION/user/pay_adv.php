...
<!-- //breadcrumbs -->
	<div id="mail" class="banner-bottom mail contact pt-5">
		...
		<h3 class="heading text-center mb-sm-5 mb-4">Pay Advance Here</h3>
			<div class="row">
                     ...
                     <div class="col-md-4"></div>
                        ...
                        <?php
                          ...
                          if(isset($_POST['pay'])){
                              ...
                              $qry_insert=mysqli_query($con,"UPDATE bookings SET apaystatus='adv_paid' WHERE `bid`='$id'") or die(mysqli_error($con));
                                if ($qry_insert) 
                                      {
                                          echo "<script>alert('Advance Paid'); 
