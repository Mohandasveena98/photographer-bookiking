...
<?php 
		if(isset($_POST['login']))
		{
			...
			$sql=mysqli_query($con,"SELECT * FROM user WHERE email='$email' and contact='$pwd'");
			...
			if($row==1)
			{
				...
				echo '<script>alert("Change password for '.$_SESSION['fullname'].' "); window.location="change.php"; </script>';
