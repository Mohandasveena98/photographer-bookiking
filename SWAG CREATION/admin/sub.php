...
<!-- //breadcrumbs -->
	<div id="mail" class="banner-bottom mail contact pt-5">
		...
		<h3 class="heading text-center mb-sm-5 mb-4">Subscription Details</h3>
			<div class="row w3ls_banner_bottom_grids">
				...
				<div class="col-lg-10 mt-lg-0 mt-5 wthree_mail_pos">
					<table class="table table-bordered">
						...
						<tbody>
							<?php $i=1;
								$sql=mysqli_query($con,"SELECT * FROM packages,subscription,photographer where photographer.phid=subscription.phid and packages.pid=subscription.pid ORDER BY subscription.`phid` ASC") or die(mysqli_error($con));
							...
							?>
								...
								<td><?php echo date('d-m-Y',strtotime($row['subsdate'])); ?></td>
								<td><?php echo date('d-m-Y',strtotime($row['subedate'])); ?></td>
								</tr>
							<?php } ?>
						</tbody>
					</table>
