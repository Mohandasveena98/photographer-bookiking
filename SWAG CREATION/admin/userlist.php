			...
			<div class="row w3ls_banner_bottom_grids">
				...
				<div class="col-lg-6 mt-lg-0 mt-5 wthree_mail_pos">
					<table class="table table-bordered">
						...
						<tbody>
							<?php $i=1;
								$sql=mysqli_query($con,"SELECT * FROM user ORDER BY fullname ASC") or die(mysqli_error($con));
					...
					<button type="submit" name="user_report" class="btn btn-warning">User Report</button>
					</form>
					<?php
						 if(isset($_POST['user_report'])){
							echo "<script>alert('User Report'); 
