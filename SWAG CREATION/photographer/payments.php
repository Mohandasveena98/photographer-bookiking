			...
			<div class="row w3ls_banner_bottom_grids">
				<div class="col-lg-12 mt-lg-0 mt-5 wthree_mail_pos">
					<table class="table table-bordered table-striped table-hover">
							...
							<tbody>
								<?php $i=1;
								$sql=mysqli_query($con,"SELECT * FROM bookings,user where phid='$phid' and bookings.uid=user.uid and bstatus!='cancelled' and bstatus!='rejected'");
								 ...
								 <tr>
								 	...
								 	<td>
								 	 <?php $ps=$row['apaystatus'];
                                                 if($ps=='approved')
                                                 {
                                            ?>
                                            <span class="badge badge-warning">Yet to pay advance</span>
