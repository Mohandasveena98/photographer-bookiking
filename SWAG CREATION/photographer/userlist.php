...
<!-- //breadcrumbs -->
	<div id="mail" class="banner-bottom mail contact pt-5">
		...
		<h3 class="heading text-center mb-sm-5 mb-4">User Details</h3>
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							?>
								...
								<td><a href="up_pack.php?pid=<?php echo $row['pid']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i></a> <a href="del_pack.php?pid=<?php echo $row['pid']; ?>" class="btn btn-danger" onclick="return confirm('Sure to delete it?'); "><i class="fa fa-trash"></i></a></td>
								<td><?php echo $i++; ?></td>
