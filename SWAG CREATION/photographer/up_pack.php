				...
				<div class="col-lg-5 mt-lg-0 mt-5 wthree_mail_pos">
					<form action="#" method="post">
						<div class="w3_agileits_contact_left">
							<input type="text" name="pname" autocomplete="off" value="<?php echo $row['pname']; ?>" placeholder="Enter a package name" required="">
							<input type="text" name="val" autocomplete="off" value="<?php echo $row['validity']; ?>" placeholder="Set package validity" required="">
							<input type="text" name="pamt" autocomplete="off" value="<?php echo $row['pamt']; ?>" placeholder="Package Amount" required="">
