...
<!-- //breadcrumbs -->
	<div id="mail" class="banner-bottom mail contact pt-5">
		...
		<h3 class="heading text-center mb-sm-5 mb-4">My Profile</h3>
					...
					<table class="table table-bordered">
					   <tr>
					   	<th rowspan="3" colspan="2">
					   		<img src="images/<?php echo $rows['phimage']; ?>" style="height: 100px; width: 100px; ">
					   	</th>
					   </tr>
						<tr>
							<th>Name: </th>
						...
						<tr>
							<th>Firm Name: </th>
							<td><?php echo $rows['firmname']; ?></td>
							<th>Firm Address: </th>
							<td><?php echo $rows['firmaddress']; ?></td>
							<th>Location: </th>
						...
						<tr>
							<th>Firm Contact: </th>
							<td><?php echo $rows['firmcontact']; ?></td>
							<th>Firm Email: </th>
							<td><?php echo $rows['firmemail']; ?></td>
							<th>Firm Description: </th>
							<td colspan="3"><?php echo $rows['firmdescp']; ?></td>
						</tr>
				</table>
