...
<!-- //breadcrumbs -->
	<div id="mail" class="banner-bottom mail contact pt-5">
		...
		<h3 class="heading text-center mb-sm-5 mb-4">Photographer Login</h3>
				...
				<div class="col-lg-5 mt-lg-0 mt-5 wthree_mail_pos">
					<form action="#" method="post">
						<div class="w3_agileits_contact_left">
							...
							<input type="password" name="password" pattern=".{6,}" title="Six or more characters" autocomplete='off' placeholder="********" required="">
							<div class="w3_agileits_contact_right">
								<input type="submit" name="login" value="SIGN IN">
							</div><br><br>
							<a href="register.php" style="font-weight: bold; color: #E91E63;">New Here? Welcome! Please register</a>
							<br><a href="forgot.php" style="font-weight: bold; color: #E91E63;">Forgot password</a>
						</div>
...
<?php 
		if(isset($_POST['login']))
		{
			...
			$sql=mysqli_query($con,"SELECT * FROM photographer WHERE email='$email' and pwd='$pwd'");
			...
			if($row==1)
			{
				...
				echo '<script>alert("Welcome '.$_SESSION['phname'].' "); window.location="home.php"; </script>';
			}
			else
			{
